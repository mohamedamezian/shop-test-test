            ...
            <s-stack gap="base">
              <s-stack gap="small-200">
                ...
                <s-text>
                  ...
                  Shopify store, storing them as metaobjects and files. You can
                  then display your Instagram feed anywhere on your store using
                  Liquid code or theme blocks.
                </s-text>
              </s-stack>
              ...
              <s-stack gap="small-200">
                ...
                <s-text>
                  ...
                  <br />
                  3. Add the Instagram feed to your store pages using theme
                  blocks
                  <br />
